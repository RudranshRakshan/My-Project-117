...
function updateCanvas() {
    ...
    sketch = quick_draw_data_set[randomN];
    document.getElementById("given").innerHTML = "Sketch to be Drawn:" + sketch;
...
function    gotResult(error,result){
    if(error){
        ...
        document.getElementById("confi").innerHTML="Confidence:"+Math.round(result[0].confidence*100)+"%";
